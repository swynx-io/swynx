  ...
  for (const file of analysisFiles) {
    ...
    for (const fn of fns) {
      ...
      const nameRe = isEsPrivate
        ? new RegExp(`#${bareName.replace(/\$/g, '\\$')}\\b`)
        : new RegExp(`\\b${bareName.replace(/\$/g, '\\$')}\\b`);
